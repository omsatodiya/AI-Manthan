...
-- 6. Ensure templates table exists (required for admin template management)
...
-- 7. Insert the two tenants: acm and cev
...
-- 8. (Optional) Create sample admin users - password: "password123"

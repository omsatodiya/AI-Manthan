          ...
          {showHeader && (
            ...
            >
              <div className="w-6 h-6 bg-primary rounded-full flex items-center justify-center">
                <span className="text-xs font-bold text-primary-foreground">{message.user.name.charAt(0).toUpperCase()}</span>
              </div>
              <span className="font-semibold font-sans text-foreground">{message.user.name}</span>
